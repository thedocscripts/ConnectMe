  ...
  <div className="container relative mx-auto">
    <div className="items-center flex flex-wrap">
      <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
        ...
        <button className={styles.btn}> Join us!
          </button>
          </Link>
      </div>
...
const Footer = ()=> <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
    ...
    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 3 <a href="https://www.connect-night.com/" className="hover:underline">ConnectMe™</a>. All Rights Reserved.
    </span>
</footer>